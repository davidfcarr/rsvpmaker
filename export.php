...
{
$sql = "SELECT * FROM $wpdb->posts LEFT JOIN $wpdb->postmeta ON $wpdb->posts.ID = $wpdb->postmeta.post_id WHERE post_type = 'rsvpmaker' AND (meta_key LIKE '_rsvpmaker_special' OR meta_key LIKE '_sked') ORDER BY meta_key, post_title ";
