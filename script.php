...
function rsvpmaker_admin_enqueue(  ) {
	...
	( ( strpos( $_GET['page'], 'rsvp_report' ) !== false ) || ( strpos( $_GET['page'], 'rsvpmaker_settings' ) !== false ) || ( strpos( $_GET['page'], 'toast' ) !== false ) ) ) ) ) {
	...
	$hastabs = (isset($_GET['page']) && ('rsvpmaker_settings' == $_GET['page']));
...
function rsvpmaker_event_scripts() {
	...
	wp_enqueue_script( 'rsvpmaker_expire_after_end', plugins_url( 'rsvpmaker-expire-after-end.js', __FILE__ ), array(), $scriptversion, true );
