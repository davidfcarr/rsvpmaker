...
const MY_VARIATION_NAME = 'rsvpmaker/rsvpmaker-loop';

wp.blocks.registerBlockVariation( 'core/query', {
    name: MY_VARIATION_NAME,
    title: 'RSVPMaker Query Loop',
    description: 'Sets up the WordPress Query Loop with RSVPMaker Template Styles',
   ...
   <g>
	...
	innerBlocks: [
		[
			...
			[ [ 'core/post-title' ], [ 'core/post-featured-image' ], [ 'rsvpmaker/loop-excerpt' ] ],
		],
