...
* Ensure display of RSVPMaker modal is triggered on all new posts. Move RSVP / Event Options button out of collapsible panel.
* Updates for WordPress 7.1
...
* Made contact form formatting in editor more consistent with individual form field blocks. Adjusted display of subject field.
* Added several patterns for different ways of displaying event listings.
