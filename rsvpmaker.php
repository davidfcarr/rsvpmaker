...
if ( $rsvp_query->have_posts() ) {
	...
	while ( $rsvp_query->have_posts() ) : $rsvp_query->the_post();
...
function rsvpmaker_server_block_render(){
	...
	register_block_type('rsvpmaker/eventlisting', ['render_callback' => 'rsvpmaker_event_listing']);
	...
	register_block_type('rsvpmaker/next-events', ['render_callback' => 'rsvpmaker_next_rsvps']);
