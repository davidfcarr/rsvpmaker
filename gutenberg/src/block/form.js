...
class FieldInspector extends Component {
	render() {
		...
		function setLabel(label) {
			...
			if (attributes.sluglocked) {// don't change default required slugs
		...
		'rsvpmaker/formselect',
		{
			...
			edit: function( props ) {
				...
				var profilename     = 'profile[' + slug + ']';
					...
					< div className = { props.className } >
				< p > < label > {label}: < / label > < span > < select className = {slug} name = {profilename} id = {slug} > {choicearray.map(
					function(opt, i){
		...
		'rsvpmaker/formradio',
		{
			...
			edit: function( props ) {
				...
				var profilename         = 'profile[' + slug + ']';
						...
						< ChoiceInspector {...props} / >
						< div className = { props.className } >
				< p > < label > {label}: < / label > < span > {choicearray.map(
					function(opt, i){
