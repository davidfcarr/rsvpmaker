...
$prev_link = '<a href="' . $req_uri . 'cm='.rsvpmaker_date('m',$linktime).'&cy='.rsvpmaker_date('Y',$linktime).'">'.rsvpmaker_date('F',$linktime).' '.rsvpmaker_date('Y',$linktime).'</a> &lt;';

// Link to next month (but do not link to too early dates)
$linktime = strtotime($monthname .' +1 month');
$next_link = '&gt; <a href="' . $req_uri . 'cm='.rsvpmaker_date('m',$linktime).'&cy='.rsvpmaker_date('Y',$linktime).'">'.rsvpmaker_date('F',$linktime).' '.rsvpmaker_date('Y',$linktime).'</a>';

$linktime = $bom;
$current_link = '<a href="' . $req_uri . 'cm='.rsvpmaker_date('m',$linktime).'&cy='.rsvpmaker_date('Y',$linktime).'">'.rsvpmaker_date('F',$linktime).' '.rsvpmaker_date('Y',$linktime).'</a>';
...
function rsvpmaker_timezone_converter ($atts) {
	...
	return sprintf('<div class="tz_converter" id="%s" time="%s" end="%s" format="%s" server_timezone="%s" post_id="%d"></div>',$id,$time,$end,$format,$server_timezone,$post_id);
